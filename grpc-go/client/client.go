...
func putMultiData(client pvd.PvdClient, request *pvd.ChainInfo) {
	...
	csvFile, err := os.OpenFile("pvd_hist_100.csv", os.O_RDONLY, os.ModePerm)
	if err != nil {
...
func main() {
	...
	case "allfield":
		queryAllDatasByField(client, &pvd.FieldInfo{Field: "Speed", Value: "80", ComOp: pvd.ComparisonOperators_Equal})
	...
	case "test1":
		testAllDatasByField(client, &pvd.FieldInfo{Field: "Speed", Value: "80", ComOp: pvd.ComparisonOperators_Equal})
