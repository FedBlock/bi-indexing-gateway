...
func (x *PvdHistData) Reset() {
	*x = PvdHistData{}
	mi := &file_index_server_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PvdHistData) Descriptor() ([]byte, []int) {
	return file_index_server_proto_rawDescGZIP(), []int{8}
}
...
const file_index_server_proto_rawDesc = "" +
	"\n" +
	"\x12index_server.proto\x12\tidxserver\"\xda\x01\n" +
	...
	"\x06Status\x18\v \x01(\tR\x06Status\"\xbf\b\n" +
	"\fPvdHist_data\x12#\n" +
...
var (
	...
	file_index_server_proto_rawDescData []byte
)

func file_index_server_proto_rawDescGZIP() []byte {
	file_index_server_proto_rawDescOnce.Do(func() {
		file_index_server_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_index_server_proto_rawDesc), len(file_index_server_proto_rawDesc)))
	})
	return file_index_server_proto_rawDescData
}

var file_index_server_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_index_server_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_index_server_proto_goTypes = []any{
...
func file_index_server_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_index_server_proto_rawDesc), len(file_index_server_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
